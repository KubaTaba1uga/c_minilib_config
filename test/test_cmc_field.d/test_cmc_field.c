...
void test_iter_array_macro_should_visit_all_elements(void) {
  ...
  int count = 0;
  CMC_FOREACH_FIELD_ARRAY(val, char *, &arr, {
    if (count == 0) {
...
void test_iter_dict_macro_should_visit_all_entries(void) {
  ...
  int sum = 0, matched = 0;
  CMC_FOREACH_FIELD_DICT(val, int *, &dict, {
...
void test_iter_array_macro_should_visit_all_nested_elements(void) {
  ...
  int count = 0;
  CMC_FOREACH_FIELD_ARRAY(val, void *, &arr, {
    struct cmc_ConfigField *subfield = __val_subfield;
    ...
    case cmc_ConfigFieldTypeEnum_ARRAY: {
      CMC_FOREACH_FIELD_ARRAY(nval, char *, &subfield, {
